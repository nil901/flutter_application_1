...
class ApiService {
  ...
  final Dio _dio = Dio(
    BaseOptions(
      ...
      headers: {
        ...
        // 'Authorization': 'Bearer ${AppPreference().getString(PreferencesKey.student_id).toString()}', // Avoids null and removes the extra }
      },
    ),
  );
  ...
  Future<Response?> getRequest(
    ...
    log("endpointqueryParams: $endpoint");
      ...
      final response = await _dio.post(
        ...
        options: Options(
          headers: {
            ...
            'Authorization': tokens != null ? 'Bearer $tokens' : '',
          },
        ),
      );
