...
class PendingFromScreen extends ConsumerStatefulWidget {
  const PendingFromScreen(this.data, {super.key});
  final GetPendingFollowsByMember data;

  @override
  ConsumerState<PendingFromScreen> createState() => _PendingFromScreenState();
}

class _PendingFromScreenState extends ConsumerState<PendingFromScreen> {
  @override
  void initState() {
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 2),
              Text(
                "Schedule : ${formatScheduleDate(meetingDate)} $schedule",
