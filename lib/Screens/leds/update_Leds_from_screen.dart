...
class UpdateLeadsFromScreen extends ConsumerStatefulWidget {
  const UpdateLeadsFromScreen(this.data, {super.key});
  final GetPendingFollowsByMember data;

  @override
  ConsumerState<UpdateLeadsFromScreen> createState() =>
      _UpdateLeadsFromScreenState();
}

class _UpdateLeadsFromScreenState
    extends ConsumerState<UpdateLeadsFromScreen> {
